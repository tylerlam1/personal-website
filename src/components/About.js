    ...
    return (
        <div className = 'about'>
            ...
            <div className='text'>
                <h1>Tyler Lam</h1>
                <p>
                    Hi! I'm Tyler. I'm currently a student at the University of Calgary. I'm current majoring in Software Engineering with a specialization in Biomedical Engineering.
                    <br />
                    <br />
